      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div id="contact">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@divantrade.com" className="text-zinc-500 hover:text-accent text-sm transition-colors">
                  info@divantrade.com
                </a>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-zinc-600 text-sm">
            &copy; {new Date().getFullYear()} Divan Trade. All rights reserved.
          </p>
