      ...
      <div className="relative max-w-2xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#contact"
              className="inline-flex items-center justify-center px-7 py-3 rounded-full bg-accent text-black font-semibold text-sm hover:bg-accent/90 transition-colors duration-300"
            >
              Get in Touch
            </a>
            <a
