...
const SERVICE_ICONS = [LuFilm, LuFileSearch, LuClapperboard, LuMic, LuTv, LuPenTool, LuGlobe, LuMicVocal, LuPalette];
const SERVICE_KEYS = ['documentary', 'investigationsResearch', 'dramaDocudrama', 'interviewProduction', 'fullEpisodeProduction', 'scriptDevelopment', 'internationalProduction', 'voiceOver', 'graphics'] as const;
